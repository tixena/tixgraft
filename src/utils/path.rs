...
pub fn get_unique_filename(path: PathBuf) -> PathBuf {
    ...
    loop {
        ...
        if counter > 10000 {
            return parent.join(format!("{}-final", stem));
        }
    }
}
...
mod tests {
    ...
    fn test_get_file_extension() {
        ...
        assert_eq!(get_file_extension(Path::new("path/file.json")), Some("json".to_string()));
    }
    ...
    fn test_normalize_separators() {
        ...
        assert_eq!(normalize_separators("mixed\\path/to\\file"), "mixed/path/to/file");
    }
